...
export default function Skills() {
  ...
  const skills = [
    ...
    { name: "Next.js", icon: "https://simpleicons.org/icons/nextdotjs.svg", level: 80 },
      { name: "Python", icon: "https://simpleicons.org/icons/python.svg", level: 95 },
      { name: "SQL", icon: "https://simpleicons.org/icons/mysql.svg", level: 90 },
      { name: "Power BI", icon: "https://simpleicons.org/icons/powerbi.svg", level: 85 },
      { name: "Pandas", icon: "https://simpleicons.org/icons/pandas.svg", level: 90 },
      { name: "NumPy", icon: "https://simpleicons.org/icons/numpy.svg", level: 85 },
      { name: "Scikit-learn", icon: "https://simpleicons.org/icons/scikitlearn.svg", level: 85 },
      { name: "Matplotlib", icon: "https://simpleicons.org/icons/matplotlib.svg", level: 80 },
      { name: "Seaborn", icon: "https://seaborn.pydata.org/_static/logo-wide-lightbg.svg", level: 80 },
      { name: "Estatística", icon: "https://cdn-icons-png.flaticon.com/512/2991/2991148.png", level: 85 },
      { name: "Machine Learning", icon: "https://cdn-icons-png.flaticon.com/512/2721/2721297.png", level: 85 },
      { name: "Storytelling com Dados", icon: "https://cdn-icons-png.flaticon.com/512/3135/3135715.png", level: 80 },
      { name: "Dashboards", icon: "https://cdn-icons-png.flaticon.com/512/1828/1828919.png", level: 80 },
  ];
