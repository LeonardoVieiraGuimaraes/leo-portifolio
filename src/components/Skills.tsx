...
export default function Skills() {
  ...
  const skills = [
    { name: "Python para Dados", icon: "https://simpleicons.org/icons/python.svg", level: 98 },
    { name: "Pandas (ETL e análise)", icon: "https://simpleicons.org/icons/pandas.svg", level: 95 },
    { name: "NumPy (cálculo científico)", icon: "https://simpleicons.org/icons/numpy.svg", level: 92 },
    { name: "Scikit-learn (ML)", icon: "https://simpleicons.org/icons/scikitlearn.svg", level: 90 },
    { name: "Matplotlib & Seaborn (visualização)", icon: "https://simpleicons.org/icons/matplotlib.svg", level: 88 },
    { name: "Power BI (dashboards)", icon: "https://simpleicons.org/icons/powerbi.svg", level: 85 },
    { name: "SQL (PostgreSQL, MySQL)", icon: "https://simpleicons.org/icons/mysql.svg", level: 90 },
    { name: "Machine Learning", icon: "https://cdn-icons-png.flaticon.com/512/2721/2721297.png", level: 90 },
    { name: "Estatística Aplicada", icon: "https://cdn-icons-png.flaticon.com/512/2991/2991148.png", level: 88 },
    { name: "Storytelling com Dados", icon: "https://cdn-icons-png.flaticon.com/512/3135/3135715.png", level: 85 },
    { name: "Dashboards Interativos", icon: "https://cdn-icons-png.flaticon.com/512/1828/1828919.png", level: 85 },
    { name: "Jupyter Notebooks", icon: "https://simpleicons.org/icons/jupyter.svg", level: 85 },
    { name: "APIs para Dados (FastAPI, Flask)", icon: "https://simpleicons.org/icons/flask.svg", level: 80 },
    { name: "Git & Versionamento", icon: "https://simpleicons.org/icons/git.svg", level: 80 },
    { name: "Cloud (deploy de modelos)", icon: "https://simpleicons.org/icons/azuredevops.svg", level: 75 },
    { name: "React para DataViz", icon: "https://simpleicons.org/icons/react.svg", level: 75 },
  ];
