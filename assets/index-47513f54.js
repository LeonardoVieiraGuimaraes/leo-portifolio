  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container mx-auto my-4  p-5", id: "about", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto mt-20 max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " w-full rounded-lg bg-blue-100 p-4 ps-16  md:ps-44 md:pr-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " p-4 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: " text-justify text-lg text-gray-700", children: [
        ...
        ", conto com uma sólida formação acadêmica e ampla experiência. Mestre em Modelagem Computacional e Sistemas pela UNIMONTES, minha expertise também abrange especialização em Matemática e Estatística. Graduei-me em Engenharia de Computação e Matemática, desempenhando o papel de Professor de Ensino Superior, lecionando disciplinas como Matemática Financeira, Probabilidade, Tecnologia da Informação e Gestão de Finanças. Além disso, contribuo na área administrativa como Assistente em Gestão de Defesa Agropecuária no IMA, demonstrando minha versatilidade profissional. Ao longo da minha carreira, participei ativamente e continuo colaborando com instituições de renome como IFNMG, UNIASSELVI e FADENORTE, agregando experiência e conhecimento diversificado. Destaco meu compromisso com o aprendizado contínuo, evidenciado pela participação em cursos complementares e eventos acadêmicos. Sou um profissional maduro, dedicado à aplicação prática do conhecimento adquirido, e permaneço aberto a novos desafios e aprendizados que contribuam para o meu constante desenvolvimento profissional."
      ] })
    ] }),
  ...
  const contacts = [
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaWhatsapp, { className: "h-10 w-10" })
    },
    {
      name: "Email",
...
const ForwardRef$1 = reactExports.forwardRef(Bars3Icon);
const Bars3Icon$1 = ForwardRef$1;
function XMarkIcon({
  title,
  titleId,
  ...props
...
function Header() {
  ...
  const navLinks = [
    { name: "Home", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaHome, {}), href: "#" },
    { name: "Sobre", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaInfoCircle, {}), href: "#about" },
    { name: "Serviços", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLaptopCode, {}), href: "#services" },
    {
      name: "Projetos",
      icon: dropdownOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaArrowUp, { className: "transform transition-transform duration-500 rotate-180" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaArrowUp, { className: "transform transition-transform duration-500" }),
      href: "#projects"
    },
    { name: "Skills", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTools, {}), href: "#skills" },
    { name: "Fale Comigo", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaEnvelope, {}), href: "#contact" }
  ];
  const projects = [
    { name: "Academicos", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaBook, {}), href: "#projectsAcademics" },
    {
      name: "Desenlvolvedor",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLaptopCode, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 right-0 flex items-center md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(XMarkIcon$1, { className: "h-8 w-8", "aria-hidden": "true" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bars3Icon$1, { className: "h-8 w-8", "aria-hidden": "true" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 md:justify-between flex items-center  md:items-stretch", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
...
function ProjectsAcademics() {
  const projects = [
    ...
    {
      title: "Improving CNN Based Feature Point Detection Through Matching Information",
    ...
    {
      title: "A Matemática Financeira Aplicada em Empréstimos e Financiamentos Bancários",
      description: "Artigo publicado ISSN 22367160",
  ...
  const services = [
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HiComputerDesktop, { className: "h-12 w-12" })
    },
    {
      title: "Sistemas",
      description: "Desenvolvimento de Sistemas e analise de dados com Python.",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HiCommandLine, { className: "h-12 w-12" })
    },
    {
      title: "Mobile",
      description: "Desenvolvimento de aplicativos Android com React Native, Kivy e Kodular.",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HiDevicePhoneMobile, { className: "h-12 w-12" })
    },
    {
      title: "Professor",
